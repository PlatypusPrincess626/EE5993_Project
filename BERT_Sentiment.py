...
with open('BERT_mental_dataset_predictions_lr4.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
model_path = "bert_sentiment_model_lr4.pt"
torch.save(model.state_dict(), model_path)

# Save label encoder to reuse label mapping
import pickle
with open("sentiment_label_encoder_lr4.pkl", "wb") as f:
